    ...
    <nav className="fixed top-0 w-full z-[100] nano-glass h-16 border-b-0">
        <div className="max-w-7xl mx-auto px-6 h-full flex items-center justify-between">
            ...
            <div className="flex items-center gap-8">
                ...
                <Link href="/login" className="px-5 py-2.5 bg-foreground text-background text-[10px] font-black rounded-full uppercase tracking-tighter transition-transform active:scale-95 shadow-xl">Connect</Link>
            </div>
        </div>
    </nav>
);
