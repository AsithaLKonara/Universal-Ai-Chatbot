            ...
            <div className="relative z-10 flex flex-col min-h-screen pt-32">
                <div className="flex-grow flex items-center justify-center p-6">
                    <div className="w-full max-w-[440px]">
                        ...
                        >
                            <Link href="/" className="w-16 h-16 bg-white text-black rounded-[22px] flex items-center justify-center mb-14 shadow-2xl hover:scale-110 transition-all border border-white/10">
                                <Command size={28} />
                            </Link>
                        </motion.div>
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="space-y-2">
                                    <div className="flex justify-between items-center px-4">
                                        <label className="text-[10px] font-black uppercase tracking-widest opacity-30 flex items-center gap-2"><Lock size={12} /> Passcode</label>
                                        <Link href="/forgot-password" className="text-[9px] font-black uppercase tracking-widest text-accent hover:text-white transition-colors">Recover?</Link>
                                    </div>
                                    <input
                                        type="password"
                                        className="w-full bg-white/[0.04] border border-white/10 focus:border-accent/50 px-6 py-5 rounded-[24px] outline-none transition-all text-sm font-bold placeholder:opacity-20"
